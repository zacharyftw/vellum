...
const nextConfig: NextConfig = {
  ...
  images: {
    // No `remotePatterns`, deliberately. Every image is vendored under
    // `public/`, so no page — marketing or app — reveals to a third-party host
    // that it was opened, or when.
